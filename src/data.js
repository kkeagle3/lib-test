export const RESULTS = {
  ...
  WITH: { 
    name: "함께 성장하는 협업러", // 🤝 누락되었던 이름을 논리적으로 채워 넣었습니다.
...
export const QUESTIONS = [
  { 
    text: "도서관에 도착하자마자\n당신이 가장 먼저 찾는 것은?", 
    options: [
      { text: "내 모든 장비를 연결할 '콘센트' 자리", weights: { ZIMCARRY: 2, CAFE: 1 } },
  ...
  { 
    ...
    options: [
      ...
      { text: "다음 수업 과제나 퀴즈를 미리 끝내려고", weights: { FOCUS: 2, OWL: 1 } }
    ] 
  },
  { 
    text: "당신이 선호하는\n학습 공간의 분위기는?", 
    options: [
      ...
      { text: "탁 트인 개방석", weights: { CAFE: 2, WITH: 1 } }
    ] 
  },
  { 
    text: "공부하다가 아는 사람을\n마주쳤을 때 당신은?", 
    options: [
      { text: "눈인사만 하고 재빨리 공부 모드 복귀", weights: { FOCUS: 2, OWL: 1 } },
      { text: "잠깐이라도 의자 빼고 앉아서 근황 토크", weights: { WITH: 2, TOURIST: 1 } }
    ] 
  },
  { 
    text: "자리에 앉아 가방을 열었을 때\n당신의 소지품 상태는?", 
    options: [
      { text: "노트북, 패드, 보조배터리 등 기기가 가득", weights: { ZIMCARRY: 2, CAFE: 1 } },
      { text: "책 한 권, 필통 하나로 끝내는 단촐함", weights: { FOCUS: 2, OWL: 1 } }
    ] 
  },
  { 
    text: "옆자리 사람이 주기적으로\n'바스락' 소리를 낸다면?", 
    options: [
      { text: "신경 쓰여서 속으로 화를 참거나 자리를 옮긴다", weights: { FOCUS: 2 } },
      { text: "백색소음이라 생각하며 내 할 일에 집중한다", weights: { CAFE: 2, TOURIST: 1 } }
    ] 
  },
  { 
    text: "공부 효율이 가장\n잘 나오는 환경은?", 
    options: [
      { text: "아무도 나를 방해하지 않는 1인 모드", weights: { FOCUS: 2, OWL: 1 } },
      { text: "서로 감시(?)하며 자극받는 스터디 모드", weights: { WITH: 2, CAFE: 1 } }
    ] 
  },
  { 
    ...
    options: [
      ...
      { text: "잠깐 나가서 친구랑 커피 마시는 시간", weights: { TOURIST: 2, WITH: 1 } }
    ] 
  },
  { 
    text: "공부하다 배가 고파지면 당신은?", 
    options: [
      { text: "빨리 먹고 복귀해서 흐름을 이어간다", weights: { OWL: 2, FOCUS: 1 } },
      { text: "맛집을 찾아 학교 밖으로 나가는 게 진정한 휴식", weights: { TOURIST: 2, WITH: 1 } }
    ] 
  },
  { 
    text: "시험 3일 전, 당신의 상태는?", 
    options: [
      { text: "평소와 다름없는 루틴을 유지한다", weights: { FOCUS: 2, ZIMCARRY: 1 } },
  ...
  { 
    ...
    options: [
      { text: "카페인을 때려 붓고 어떻게든 앉아 있는다", weights: { OWL: 2, FOCUS: 1 } },
